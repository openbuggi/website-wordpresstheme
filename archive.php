...
<?php if ( have_posts() ) : ?>
				...
				<div class="introduction">
					<h3 class="page-title">
						<?php if ( is_day() ) : ?>
							<?php printf( __( 'Daily Archives: %s', 'openbuggi' ), '<span>' . get_the_date() . '</span>' ); ?>
						<?php elseif ( is_month() ) : ?>
							<?php printf( __( 'Monthly Archives: %s', 'openbuggi' ), '<span>' . get_the_date( 'F Y' ) . '</span>' ); ?>
						<?php elseif ( is_year() ) : ?>
							<?php printf( __( 'Yearly Archives: %s', 'openbuggi' ), '<span>' . get_the_date( 'Y' ) . '</span>' ); ?>
						<?php else : ?>
